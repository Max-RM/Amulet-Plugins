...
class SetBlock(wx.Panel, DefaultOperationUI):
    ...
    def __init__(
        ...
        self._run_getSData_button = wx.Button(self, label="Get portals DATA")
        ...
        self._run_text.SetValue("portals in this world")
        self._run_setSData_button = wx.Button(self, label="Save portals  \n Data to world ")
    ...
    def _run_set_data(self, _):  #b'portals:test'
    ...
    def _run_set_sdata(self, _):
        if 'portals' not in self._run_text.GetValue():
            fixKey = "portals" + self._run_text.GetValue()
    ...
    def _run_export(self, _):  # b'portals:test'
    ...
    def _run_get_slist(self):
        ...
        currentStructure = []
        currentStructure.append("Portals In this World")
        for w in world:
            if b'\xff' not in w:
                if b'\x00' not in w:
                    if b'portals' in w:
...
export = dict(name="v001 Edit/Export/Import Portal-Data Updated", operation=SetBlock)
